export const en = {
  ...
  pool: {
    ...
    titleAriaLabel: "Pool title",
    iconPlaceholder: "✨",
    iconAriaLabel: "Pool icon",
    addOption: "Add option",
    optionPlaceholder: "Option name",
    minOptions: "Add at least 3 options",
    maxOptions: "Max 8 options",
    optionCountOne: "1 option",
    optionCountMany: "{count} options",
  ...
  settings: {
    title: "Settings",
    sound: "Sound",
    soundDesc: "Tick, click, and chime cues during reveals.",
    reducedMotion: "Reduce motion",
    reducedMotionDesc: "Snap to results without long animations.",
    analytics: "Help us improve",
    analyticsDesc:
      "Send anonymous usage events. No names, no content. Opt out anytime.",
    clearHistory: "Clear history",
    clearHistoryConfirm: "Clear all reveal history?",
